...
\section{Experience}
  \eventListStart
    ...
    \eventWithDetail
      ...
      \entryListStart
        \generalEntry 
          {Launched AWS IoT SiteWise Edge which provides software that runs on premises at industrial sites and makes it easy to collect, process, and monitor equipment data locally before sending the data to AWS Cloud destinations.}
        \generalEntry 
          {Dramatically improved the performance of data processing module in IoT SiteWise Edge software from 2 to over 1k+ TPS.}
        \generalEntry
          {Added Grafana support to read data from AWS IoT SiteWise and showing it in a Grafana dashboard.}
      \entryListEnd
    \eventWithDetail
    % good
