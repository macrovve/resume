...
\section{Education}
  \eventListStart
    \eventWithMoreDetail
      ...
      {Master in Computer Science;  GPA: 3.83}{Sep. 2018 -- May. 2020}
...
\section{Project}
  \eventListStart
    ...
    \entryWithKeyword{Web Search Engine}{A web search engine indexed over 4 million pages and its retrieval time was less than 0.5s per query.}
  \eventListEnd
