...
\section{Education}
  \eventListStart
    \eventWithMoreDetail
      ...
      {Current TA for CS6083 Principles of Database Systems}
    \eventWithDetail
  ...
  \eventListStart
    ...
    \eventWithDetail
        ...
        \entryListStart
            ...
            \generalEntry
                {Promoted the extensibility and control granularity of the sensor by designing a special description file.}
        \entryListEnd
...
\section{Project}
  \eventListStart
    \generalEvent
      ...
      \entryListStart
        \generalEntry
            {Designed a note share website using the Laravel framework in PHP. The users are able to publish notes linking to certain locations, date-time or tag. Their friends could receive the notes based on their custom filters. The website also supports comments, friend management, and note search.}
        \generalEntry
...
\section{Programming Skills}
 \eventListStart
    ...
    \entryWithKeyword{Technologies}{Git, Vue.js, Vim, Bash, Regex, Docker, Markdown, MySQL, AWS}
 \eventListEnd
